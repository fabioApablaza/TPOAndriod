...
public class Utilidades {
    ...
    public static final String CREAR_TABLA_CONTACTO = "CREATE TABLE "+TABLA_CONTACTO+" ( "+NOMBRE+" TEXT , "+APELLIDO+" TEXT , "+TELEFONO+" TEXT PRIMARY KEY NOT NULL, "+DIRECCIONPOSTAL+" TEXT, "+FECHANAC+" TEXT )";
